...
- [x] **Etapa 2** — Tela Explorar (busca com debounce, filtros, grid infinito, favoritar) + detalhe inicial do personagem
- [ ] Etapa 3 — Detalhe completo (radar de poderes, trilha sonora, conexões, times)
